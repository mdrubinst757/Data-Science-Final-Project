...
##This file will find the classification error rates using the top keywords most
##associated with healthcare websites as determined by the chi-squared selection
##criteria combined with the lasso regression. These keywords were selected by
##size of chi-squared residuals in the Determining Keywords.R file.
...
table
table$classifier <- rep(2, nrow(table))
write.csv(table, 'cc2.csv', row.names=T, sep=',')
