...
<div class="centered"
![Nonhealthcare](https://raw.githubusercontent.com/mdrubinst757/Data-Science-Final-Project/master/naics.png)
</div>
...
datatable <- data.frame(NAICS.Codes, Percent.Health.Related, Descriptions)
library(knitr)
...
## Example 1
<div class="centered">
![Nonhealthcare](https://raw.githubusercontent.com/mdrubinst757/Data-Science-Final-Project/master/nonhealth.png)
</div>

## Example 2
<div class="centered">
![healthcare](https://raw.githubusercontent.com/mdrubinst757/Data-Science-Final-Project/master/hc.png)
</div>
...
<div class="centered">
![rplot](https://raw.githubusercontent.com/mdrubinst757/Data-Science-Final-Project/master/rplot.png)
</div>
...
Pct.Correctly.Classified <- c("68.6%", "67.8%", "NA", "74.0%", "77.1%", "86.3%", "77.1%", "85.1%")

Keywords.Method <- c("ChiT100", "ChiT100","ChiT100","ChiT100","ChiT100","ChiT100","ChiT100","ChiT100")
                
# Combine
datatable <- data.frame(Model, Pct.Correctly.Classified, Keywords.Method)
library(knitr)
knitr::kable(datatable)       
...
## Extra Table 2: Top 50 Pos, Top 50 Neg
```{r, echo=FALSE, results='asis', cache=FALSE}
...
Pct.Correctly.Classified <- c("70.1%", "70.4%", "NA", "70.9%", "88.4%", "92.0%", "NA", "88.6%")

Keywords.Method <- c("Chi5050","Chi5050","Chi5050","Chi5050","Chi5050","Chi5050","Chi5050","Chi5050")
