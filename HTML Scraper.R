...
##This script first obtains the html code behind a list of websites. However,
##the websites that do not work have to be removed manually. The script then
##cleans the text and creates a list of all uni-grams, bi-grams, and tri-grams
##from the HTML code, creating a document-term matrix. This DTM is then output
##as a CSV.
